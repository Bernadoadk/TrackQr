...
const PATHS: Record<string, React.ReactNode> = {
  ...
  "bar-chart": <><path d="M3 3v18h18"/><path d="M7 16V9"/><path d="M12 16v-5"/><path d="M17 16v-3"/></>,
  ...
  "package": <><path d="m7.5 4.27 9 5.15"/><path d="M21 8 12 13 3 8"/><path d="M3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8z"/><path d="m12 22.08 0-10"/></>,
  ...
  "save": <><path d="M19 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11.172a2 2 0 0 1 1.414.586l2.828 2.828A2 2 0 0 1 21 7.828V19a2 2 0 0 1-2 2z"/></>,
  ...
  "layers": <><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 12.65-8.56 3.89a2 2 0 0 1-1.66 0L3.34 12.6"/><path d="m22 17.65-8.56 3.89a2 2 0 0 1-1.66 0L3.34 17.6"/></>,
  "panel-left": <><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></>,
  "layout": <><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></>,
  "mouse-pointer": <><path d="m4 4 7.07 17 2.51-7.39L21 11.07z"/></>,
  "video": <><path d="m22 8-6 4 6 4V8Z"/><rect width="14" height="12" x="2" y="6" rx="2" ry="2"/></>,
  "arrow-left": <><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></>,
  "id-card": <><rect width="20" height="14" x="2" y="5" rx="2"/><path d="M2 10h20"/><circle cx="7" cy="15" r="2"/><path d="M13 13h4"/><path d="M13 16h3"/></>,
  ...
  "bold": <><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h9a4 4 0 0 1 0 8H6z"/></>,
